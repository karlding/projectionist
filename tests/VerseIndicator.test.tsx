...
describe('VerseIndicator', () => {
  it('renders current verse and total (verse number bold)', () => {
    const { container } = render(<VerseIndicator currentVerse={1} totalVerses={3} />);
  ...
  it('renders verse 2 / 3 with 2 bolded', () => {
    const { container } = render(<VerseIndicator currentVerse={2} totalVerses={3} />);
  ...
  it('shows C with font-medium when hasChorus is true and not on chorus page', () => {
    render(
      <VerseIndicator currentVerse={1} totalVerses={3} hasChorus isChorus={false} />
    );
